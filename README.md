...
În partea de sus, utilizatorul va selecta data plecării și data returului și numărul de persoane care vor participa. În colțul din dreapta vom prezenta temperaturile care vor fi în orașul ales în perioada selectată. În partea de jos vom avea două tab-uri care îi vor permite utilizatorului să aleagă un loc de cazare și un zbor dacă este necesar. Am luat în calcul posibilitatea ca un utilizator să își dorească să ajungă la locația aleasă cu propriul mijloc de transport, iar în cazul acesta nu va fi nevoie de cumpărarea unui bilet de avion. Va fi activ un singur tab la un moment dat. În mod implicit, va fi activ tab-ul CAZARE. Aici va fi o listă de hoteluri. Utilizatorul va putea da click pentru a vedea mai multe detalii precum facilități și tarife pentru un anumit hotel, iar pentru a face rezervare, se va folosi de un checkbox care se va găsi în partea dreaptă, în dreptul hotelului.
